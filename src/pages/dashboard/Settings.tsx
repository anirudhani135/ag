                ...
                <div className="border rounded-lg p-4 bg-muted/20 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 bg-blue-100 rounded-full flex items-center justify-center text-blue-600">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-github"><path d="M17.6 9.5H12v3h3.1c-.3 1.4-1.5 2.5-3.1 2.5-1.9 0-3.5-1.6-3.5-3.5S10.1 8 12 8c.8 0 1.5.3 2.1.7l2.3-2.3C15.1 5.2 13.6 4.5 12 4.5c-3.6 0-6.5 2.9-6.5 6.5s2.9 6.5 6.5 6.5c5.5 0 6.7-5.3 6.1-8z"></path><path d="M9 18c-4.51 2-5-2-7-2"></path></svg>
                    </div>
                    <div>
